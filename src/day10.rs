...
impl Signal {
    ...
    fn get_value(&self) -> Option<usize> {
        match self {
            Signal::CloseBracket => Some(3),
            Signal::CloseSquare => Some(57),
            Signal::CloseCurly => Some(1197),
            Signal::CloseAngle => Some(25137),
            _ => None,
        }
    }
}
